...
export function Header() {
  ...
  return (
    <header
      className="sticky top-0 w-full overflow-hidden border-b border-border bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/80"
    ...
    >
      <div className="mx-auto flex h-28 max-w-6xl items-center justify-between gap-4 px-4 sm:px-6">
        <a href="#top" aria-label="Rebel Removal home" className="shrink-0">
          <Logo priority imageClassName="h-40 w-40" />
        </a>
